...
VALUES
  ('DevTool Pro', 'The ultimate developer toolkit', 'Comprehensive development suite', 'Easy integration with existing workflow', '/icons/devtool.png', 'https://devtool.pro', '{"views": 0, "reviews": 0}', 'b9b6bd98-b64b-433f-b230-016bffa349de', 1, NOW(), NOW()),
  ('DesignMaster', 'Design like a pro', 'Professional design platform', 'Intuitive interface for designers', '/icons/design.png', 'https://designmaster.app', '{"views": 0, "reviews": 0}', 'b9b6bd98-b64b-433f-b230-016bffa349de', 2, NOW(), NOW()),
  ('MarketGenius', 'Smart marketing automation', 'AI-powered marketing platform', 'Automated marketing workflows', '/icons/market.png', 'https://marketgenius.io', '{"views": 0, "reviews": 0}', 'b9b6bd98-b64b-433f-b230-016bffa349de', 3, NOW(), NOW()),
  ('CodeBuddy', 'Your coding companion', 'AI pair programming assistant', 'Real-time code suggestions', '/icons/code.png', 'https://codebuddy.dev', '{"views": 0, "reviews": 0}', 'b9b6bd98-b64b-433f-b230-016bffa349de', 4, NOW(), NOW()),
  ('DataViz', 'Beautiful data visualization', 'Turn data into insights', 'Drag-and-drop visualization builder', '/icons/dataviz.png', 'https://dataviz.app', '{"views": 0, "reviews": 0}', 'b9b6bd98-b64b-433f-b230-016bffa349de', 5, NOW(), NOW());

-- Seed product upvotes (bridge table)
INSERT INTO product_upvotes (product_id, profile_id)
VALUES (1, 'b9b6bd98-b64b-433f-b230-016bffa349de');
...
VALUES
  ('Getting Started with DevTool Pro', 'A comprehensive guide to DevTool Pro...', 1, 'b9b6bd98-b64b-433f-b230-016bffa349de', NOW(), NOW()),
  ('Design Tips and Tricks', 'Essential design principles...', 2, 'b9b6bd98-b64b-433f-b230-016bffa349de', NOW(), NOW()),
  ('Marketing Automation Best Practices', 'How to automate your marketing...', 3, 'b9b6bd98-b64b-433f-b230-016bffa349de', NOW(), NOW()),
  ('Launching Your First Product', 'Steps to a successful product launch...', 4, 'b9b6bd98-b64b-433f-b230-016bffa349de', NOW(), NOW()),
  ('AI in Modern Development', 'How AI is changing development...', 5, 'b9b6bd98-b64b-433f-b230-016bffa349de', NOW(), NOW());
...
VALUES
  (1, 'b9b6bd98-b64b-433f-b230-016bffa349de', 'Great post about DevTool Pro!', NOW(), NOW()),
  (2, 'b9b6bd98-b64b-433f-b230-016bffa349de', 'These design tips are very helpful', NOW(), NOW()),
  (3, 'b9b6bd98-b64b-433f-b230-016bffa349de', 'Marketing automation is crucial', NOW(), NOW()),
  (4, 'b9b6bd98-b64b-433f-b230-016bffa349de', 'Launch strategy is on point', NOW(), NOW()),
  (5, 'b9b6bd98-b64b-433f-b230-016bffa349de', 'AI is indeed transforming development', NOW(), NOW());

-- Seed gpt ideas
INSERT INTO gpt_ideas (idea, views, claimed_by, created_at)
VALUES
  ('AI-powered code review assistant', 0, 'b9b6bd98-b64b-433f-b230-016bffa349de', NOW()),
...
VALUES (1, 'b9b6bd98-b64b-433f-b230-016bffa349de', NOW());

-- Seed messages
INSERT INTO messages (message_room_id, sender_id, content, created_at)
VALUES
  (1, 'b9b6bd98-b64b-433f-b230-016bffa349de', 'Hello! Interested in collaboration', NOW()),
  (1, 'b9b6bd98-b64b-433f-b230-016bffa349de', 'Let''s discuss the project details', NOW()),
  (1, 'b9b6bd98-b64b-433f-b230-016bffa349de', 'What''s your availability?', NOW()),
  (1, 'b9b6bd98-b64b-433f-b230-016bffa349de', 'I can start next week', NOW()),
  (1, 'b9b6bd98-b64b-433f-b230-016bffa349de', 'Great, looking forward to working together', NOW());

-- Seed notifications
INSERT INTO notifications (source_id, product_id, post_id, target_id, type, created_at)
VALUES
  ('b9b6bd98-b64b-433f-b230-016bffa349de', 1, NULL, 'b9b6bd98-b64b-433f-b230-016bffa349de', 'review', NOW()),
  ('b9b6bd98-b64b-433f-b230-016bffa349de', NULL, 1, 'b9b6bd98-b64b-433f-b230-016bffa349de', 'reply', NOW()),
  ('b9b6bd98-b64b-433f-b230-016bffa349de', NULL, NULL, 'b9b6bd98-b64b-433f-b230-016bffa349de', 'follow', NOW()),
  ('b9b6bd98-b64b-433f-b230-016bffa349de', NULL, 2, 'b9b6bd98-b64b-433f-b230-016bffa349de', 'mention', NOW()),
  ('b9b6bd98-b64b-433f-b230-016bffa349de', 2, NULL, 'b9b6bd98-b64b-433f-b230-016bffa349de', 'review', NOW());
